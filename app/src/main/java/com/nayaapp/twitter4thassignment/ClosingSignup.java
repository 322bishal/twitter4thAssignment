...
public class ClosingSignup extends AppCompatActivity {
    Button btn_signup;
    String email="";
    String username="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_signup.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( ClosingSignup.this, Verification.class );
...
tvemail.setOnClickListener( new View.OnClickListener() {
    ...
    void returnto(){
        Intent returns=new Intent( ClosingSignup.this,SignUP.class );
